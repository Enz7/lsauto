...
import { FinancingCalculators } from '../components/FinancingCalculators';
...
export const Home = () => {
  ...
  return (
    <div className="animate-in fade-in duration-700 space-y-16 md:space-y-32">
      <Helmet>
      ...
      <div>
        <Hero />
        {!isLoggedIn && (
          <div className="mt-10 md:mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-white/5 pt-10 md:pt-20">
            {[
        ...
        <section className="space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="bg-dark-card border border-white/5 p-5 md:p-8 rounded-[2rem] hover:border-primary/20 transition-all group">
      ...
      {!isLoggedIn && (
        <section className="bg-primary rounded-[2rem] md:rounded-[3rem] p-6 sm:p-12 md:p-20 text-black overflow-hidden relative">
          <div className="relative z-10 space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/register" className="bg-black text-white px-6 py-4 md:px-10 md:py-5 rounded-2xl font-black uppercase text-sm hover:scale-105 transition-all">Присоединиться</Link>
              <Link to="/about" className="border-2 border-black px-6 py-4 md:px-10 md:py-5 rounded-2xl font-black uppercase text-sm hover:bg-black hover:text-white transition-all">Узнать больше</Link>
            </div>
          </div>
