...
export const RequestModal = ({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      submitRequest({ brand, model, budget: 5000000, comment: 'Нужен подбор' });
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-dark-card border border-white/10 w-full max-w-xl rounded-3xl overflow-hidden animate-in zoom-in-95 duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input type="number" placeholder="Напр: 5 000 000" className="w-full bg-dark-input border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:ring-1 focus:ring-primary outline-none" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Напр: 2021-2024" className="w-full bg-dark-input border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:ring-1 focus:ring-primary outline-none" />
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-gray-500 uppercase">Ваш город</label>
              <input type="text" placeholder="Напр: Москва" className="w-full bg-dark-input border border-white/10 rounded-xl py-3 px-4 text-sm focus:ring-1 focus:ring-primary outline-none" />
            </div>
          </div>
